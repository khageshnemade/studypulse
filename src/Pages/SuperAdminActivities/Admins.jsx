          ...
          {admins.map((admin) => (
            ...
            >
              <div className="p-6 text-center">
                <h2 className="text-2xl font-semibold text-gray-900">{admin.firstName} {admin.lastName}</h2>
                <p className="text-gray-600 text-sm mt-2">Email: {admin.email}</p>
                <p className="text-gray-600 text-sm">Phone: {admin.phoneNumber}</p>
                <p className="text-gray-700 font-medium mt-2">Role: {admin.role}</p>
                <p
