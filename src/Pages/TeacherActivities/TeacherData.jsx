  ...
  return (
    <div className="">
      <div className="grid gap-6">
        {/* User Information */}
        <p className="text-center text-2xl sm:text-3xl md:text-4xl font-semibold bg-blue-400 md:p-5 rounded-2xl flex w-full sm:w-4/6 justify-center items-center mx-auto text-gray-700 m-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {formData?.qualification &&
              Object.entries(formData.qualification).map(([key, value]) => (
                <div
                  key={key}
                  className="p-6 border-2 border-gray-200 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-gray-50"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {formData.experience &&
              formData.experience.map((exp, index) => (
                <div
                  key={exp._id}
                  className="p-6 bg-gray-50 border-2 border-gray-200 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300"
                >
