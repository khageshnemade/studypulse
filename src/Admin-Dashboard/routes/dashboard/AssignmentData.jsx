    ...
    <div className="p-6 flex flex-col h-full justify-between">
      ...
      <div className="flex-1 overflow-y-auto">
        <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
          <thead>
            <tr>
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-700 bg-blue-200">Student Name</th>
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-700 bg-blue-200">Assignment</th>
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-700 bg-blue-200">Attempts</th>
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-700 bg-blue-200">Status</th>
            </tr>
          </thead>
          <tbody>
            {filteredData.map((student) => (
              <tr key={student.studentId}>
                ...
                <td className="px-6 py-4 text-sm text-gray-800">{student.assignment}</td>
                <td className="px-6 py-4 text-sm text-gray-800">{student.attempts}</td>
