...
//     return (
//       <div>
//         <h2 className="text-2xl font-semibold mb-4 bg-gradient-to-r from-green-500 to-teal-300 text-white p-2 rounded-md w-full text-center font-serif">
//           Class Performance
//         </h2>
...
//             </div>
//             <p className="text-4xl font-extrabold text-green-600  rounded-lg py-2">
...
//             </div>
//             <p className="text-4xl font-extrabold text-indigo-500  rounded-lg py-2">
...
//           <h2 className="text-2xl font-semibold  text-center mb-4 bg-gradient-to-r from-green-500 to-teal-300 text-white p-2 rounded-md shadow-md font-serif">
//             Student Pass/Fail Stats
//           </h2>
