  ...
  return (
    <div className="grid grid-cols-3 m-2 p-2">
      ...
      <div className="col-span-2 w-full">
        <div className="p-10 bg-white border border-gray-300 max-w-full mx-auto mt-7 flex-grow print:border-none print:p-4">
          {/* Header Section */}
          <div className="grid grid-cols-3 border-b border-gray-400 pb-4">
            <div>
              <p className="text-sm">
          ...
          <div className="flex justify-between border-b border-gray-400 py-2 text-sm">
            ...
            <div className="text-right">
              ...
              <p>
                <strong>Date:</strong> {invoiceData.date} {invoiceData.time}
              </p>
              <p>
          ...
          <table className="w-full border-collapse border border-gray-400 mt-4 text-xs">
            <thead>
              <tr className="bg-gray-200">
                <th className="border border-gray-400 p-1">Particulars/HSN</th>
                <th className="border border-gray-400 p-1">Pack</th>
                <th className="border border-gray-400 p-1">M.R.P</th>
                ...
                <th className="border border-gray-400 p-1">Free</th>
                <th className="border border-gray-400 p-1">Sch Rs.</th>
                <th className="border border-gray-400 p-1">Net Amt</th>
              </tr>
            </thead>
            <tbody>
              {invoiceData.items.map((item, index) => (
                <tr key={index}>
                  ...
                  <td className="border border-gray-400 p-1">{item.pack}</td>
                  <td className="border border-gray-400 p-1">{item.mrp}</td>
                  <td className="border border-gray-400 p-1">{item.gst}</td>
                  <td className="border border-gray-400 p-1">{item.rate}</td>
                  <td className="border border-gray-400 p-1">{item.unit}</td>
                  <td className="border border-gray-400 p-1">{item.qty}</td>
                  <td className="border border-gray-400 p-1">{item.free}</td>
                  <td className="border border-gray-400 p-1">{item.schRs}</td>
                  <td className="border border-gray-400 p-1">{item.netAmt}</td>
                </tr>
              ))}
            </tbody>
          </table>
...
const Invoice1 = () => {
  ...
  return (
    <div className="p-6 bg-white border border-black shadow-md h-full">
      {/* Header */}
        ...
        <tbody>
          {invoiceData.items.map((item, index) => (
            <tr key={index} className="h-8">
              <td className="border border-gray-400 p-1">{item.particulars}</td>
...
const InvoiceFooter = () => {
  ...
  return (
    <div className="p-4 border border-gray-400 shadow-md text-sm">
      <div className="grid grid-cols-4">
        ...
        <div className="border border-gray-400">
          <table className="w-full border-collapse border border-gray-400 text-xs">
            <thead>
              <tr className="bg-gray-200">
                <th className="border border-gray-400 p-1">Goods</th>
                <th className="border border-gray-400 p-1">SGST%</th>
                <th className="border border-gray-400 p-1">Value</th>
                <th className="border border-gray-400 p-1">CGST%</th>
                <th className="border border-gray-400 p-1">Value</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr className="text-center font-bold">
                <td className="border border-gray-400 p-1">2.50</td>
        ...
        <div className="border border-gray-400 p-2">
          <table className="w-full border-collapse border border-gray-400">
            <tbody>
              <tr>
                <td className="border border-gray-400 p-1">Gross Amt.</td>
                <td className="border border-gray-400 p-1">
                  {invoiceData.amountSummary.grossAmount}
                </td>
              </tr>
              <tr>
                <td className="border border-gray-400 p-1">Less Sch.</td>
                <td className="border border-gray-400 p-1">
                  {invoiceData.amountSummary.lessSch}
                </td>
              </tr>
              <tr>
                <td className="border border-gray-400 p-1">Less CD</td>
                <td className="border border-gray-400 p-1">
                  {invoiceData.amountSummary.lessCD}
                </td>
              </tr>
              <tr>
                <td className="border border-gray-400 p-1">R.Off</td>
                <td className="border border-gray-400 p-1">
                  {invoiceData.amountSummary.roundOff}
                </td>
              </tr>
              <tr className="font-bold">
                <td className="border border-gray-400 p-1">Net Amt.</td>
                <td className="border border-gray-400 p-1">
